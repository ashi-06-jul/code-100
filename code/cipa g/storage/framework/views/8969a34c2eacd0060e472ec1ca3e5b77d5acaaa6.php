  ...
  <div class="box1">
    ...
    <h2 class="color3"><strong>S</strong>hare<strong > Y</strong>our<strong> S</strong>tory</h2>
     ...
     <div class="form-horizontal">
		...
		<tr>
			<td class="control-label col-sm-2"><h4>Write your story</h4></td><td><textarea type="text" name="detail" class="form-control" required="required" name="story" placeholder="Write or paste your story here"></textarea></td>
...
<table class="table table-bordered">
    <?php $__currentLoopData = $con; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cons): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<tr>
					<td><label class="control-label col-sm-2">Q.</label><?php echo e($cons->name); ?></td>
    			</tr>
			<tr>
			<td><label class="control-label col-sm-2"><h4>Ans.</h4></label><?php echo e($cons->photo1); ?></td>
		</tr>
...
<?php echo $__env->make('layout.story', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>