...
<table class="table table-bordered">
    <?php $__currentLoopData = $con; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cons): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<tr>
					<td><label class="control-label col-sm-2">Q.</label><?php echo e($cons->question); ?></td>
    			</tr>
			<tr>
			<td><label class="control-label col-sm-2"><h4>Ans.</h4></label><?php echo e($cons->answer); ?></td>
		</tr>
...
<div>
	<h2 class="color2"><strong>P</strong>ost <strong>Y</strong>our <strong>Q</strong>uestion <strong>H</strong>ere</h2>
		...
		<td><textarea  class="form-control" id="qu" name="question" ></textarea></td>
		</tr>
<tr>
