    ...
    <!-- content -->
     ...
     <?php $__env->startSection('getinvolved'); ?>
    <article id="content">
      <div class="wrapper">
        <div class="box1">
          <div class="line1">
            <div class="line2 wrapper">
              <section class="col1">
                <h2><strong>C</strong><span>ampaign</span></h2>
                <div class="pad_bot1">
                  <figure><img src="images/Campaign.jpg" height="100px" width="270px"></figure>
                </div>
              ...
              <section class="col1 pad_left1">
                ...
                <div class="pad_bot1">
                  <figure><img src="images/download.jpg"  height="100px" width="270px"></figure>
                </div>
                Dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi.<a href="/become_a_member" class="button1 color2">Read More</a> </section>
              <section class="col1 pad_left1">
                <h2 class="color3"><strong>S</strong>hare<span>Story</span></h2>
                <div class="pad_bot1">
                  <figure><img src="images/ShareStory_carousel_1200x550.jpg"  height="100px" width="270px"></figure>
                </div>
                Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.<a href="/story" class="button1 color3">Read More</a> </section>
            </div>
          </div>
        </div>
      </div>
...
<?php echo $__env->make('layout.getinvolved', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>