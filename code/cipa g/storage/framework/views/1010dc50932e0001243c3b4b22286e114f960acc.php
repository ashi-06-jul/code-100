          ...
          <div class="wrapper">
            <section class="col1">
              <h2><strong>N</strong>ews</h2>
                ...
                <figure class="left marg_right1"><img src="images/news.jpg" >
                </figure><br><br>
                <p><h5>News is information about current events. News is provided through many different media: word of mouth, printing, postal systems, broadcasting, electronic communication, and also on the testimony of observers and witnesses to events. It is also used as a platform to manufacture opinion for the population.<br>
